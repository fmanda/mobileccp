<template>
  <div class="app-container">
    ...
    >
      ...
      <el-menu-item index="1"><i class="el-icon-date"></i>Semua SO Mobile</el-menu-item>
    </el-menu>
    ...
    >
      ...
      <el-table-column label="orderno" prop="orderno" sortable/>
      <el-table-column label="orderdate" prop="orderdate" sortable/>
      <el-table-column label="salesman" prop="salesman" sortable/>
      <el-table-column label="customer" prop="customer" sortable/>
      <el-table-column label="Amount" prop="amt" sortable/>
      <el-table-column label="GeoLocation"fixed="right"width="140" >
...
<script>
import { getSalesOrderPeriod } from '@/api/salesorder'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      if (!dt1 ||  !dt2) return;
      getSalesOrderPeriod(dt1, dt2, this.filtertxt).then(response => {
